...
import {
  User, Mail, Phone, Shield, Pencil, Trash2, LogOut,
  ArrowRight, GraduationCap, AlertTriangle, RefreshCw, Calendar, BookOpen,
} from "lucide-react";
import { getProfile, deleteUser, UserProfile } from "@/lib/api/user";
...
export default function ProfilePage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setDeleteError(err instanceof Error ? err.message : "فشل في حذف الحساب.");
      setDeleting(false);
    }
  };
      ...
      {showDeleteModal && (
        ...
        >
          <div className="rounded-3xl p-6 sm:p-8 max-w-sm w-full shadow-2xl animate-[scaleIn_0.2s_ease-out]"
            ...
            <h2 className="text-xl font-extrabold text-center mb-2" style={{ color: C.textP }}>حذف الحساب</h2>
